...
async def async_setup_entry(
    ...
    param_labels = {}
    url = f"{api_url}/dump_devm_param_names?did={device_id}&node_id={node_id}"
...
class DatakomParamSensor(SensorEntity):
    ...
    async def async_update(self) -> None:
        # Запрос к /dump_devm?did=...&node_id=...&id=...
        url = f"{self._api_url}/dump_devm?did={self._device_id}&node_id={self._node_id}&id={self._param_id}"
